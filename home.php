...
<body>
  ...
  <section id="firstsection" class="carousel slide carousel_section" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="welcomeline">
          <h1 class="welcometag">The Royal Hotel</h1>
        </div>
  ...
  <section id="thirdsection">
    <h1 class="head">Services offered:</h1>
    <div class="facility">
      <div class="box">
        <h2>Swiming pool</h2>
      </div>
  ...
  <section id="contactus">
    <div class="social">
    <a href="https://www.instagram.com/theroyalhotelpicton/" target="_blank"><i class="fa-brands fa-instagram"></i>
